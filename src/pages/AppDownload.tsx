      ...
      <div className="pt-32 pb-20">
        <div className="mx-auto px-4 max-w-[1200px]">
          <div className="text-center mb-12">
            <h1 className="text-5xl font-bold text-[#34478F] mb-6">App下載</h1>
            <p className="text-xl text-[#5A5A5A]">隨時隨地掌握投資動態</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-16">
            <div className="bg-gradient-to-br from-[#34478F] to-[#5B6FB5] rounded-lg p-12 text-white">
            ...
            <div className="bg-[#ECF0F6] rounded-lg p-12">
              <h2 className="text-3xl font-bold text-[#34478F] mb-8 text-center">立即下載</h2>
              ...
              <div className="text-center">
                ...
                <div className="flex justify-center gap-8">
                  <div className="text-center">
                    <div className="w-32 h-32 bg-white border-2 border-[#34478F] rounded-lg mb-2"></div>
          ...
          <div className="bg-[#ECF0F6] rounded-lg p-12">
            <h2 className="text-3xl font-bold text-[#34478F] mb-8 text-center">系統要求</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                <h3 className="text-xl font-bold text-[#34478F] mb-4">iOS版本</h3>
              ...
              <div>
                <h3 className="text-xl font-bold text-[#34478F] mb-4">Android版本</h3>
                <ul className="space-y-2 text-[#666666]">
